...
import { updateAudiobooks } from '@/store/audiobooks'

export const getCategoriesReq = () => async (dispatch: AppDispatch, getState: GetState) => {
	...
	try {
		...
		dispatch(updateAudiobooks({ categories: data }))
	} catch (e: any) {
